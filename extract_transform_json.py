...
#Funtion to list each tech languge skill in JSON as new column with key as column label and value as cell in row
...
if __name__ == "__main__":
    ...
    # Call function to split tech skill score column and process the DataFrames
    processed_dfs = []
